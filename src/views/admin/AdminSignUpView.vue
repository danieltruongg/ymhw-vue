  ...
  <div class="container">
    <div class="d-flex flex-row justify-content-center h-100">
      <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
        <h2 class="text-center mb-4">Admin Creation</h2>
...
const submitSignup = async (formData) => {
  try {
    ...
    await createUserProfile(newUser.uid, 'admin', {
    ...
    alert('Admin account created successfully. Please log in again.')
  } catch (error) {
    const errorCode = error.code
    const errorMessage = error.message
    console.error('Error creating admin account:', errorCode, errorMessage)
